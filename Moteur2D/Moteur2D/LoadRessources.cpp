...
void LoadRessources::loadAllTexture() {
    ...
    mesTexture = { player, ground, enemy, bg_layer1, bg_layer2, bg_layer3, bg_layer4 , background_1, background_2, background_3, background_4, background_5, background_6, play_button, exit_button };
}
